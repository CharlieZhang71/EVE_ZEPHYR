...
typedef struct
{
	Ft_Esd_Animation Instance;
	Esd_AnimationInfo * AnimationInfo;
} Ft_Esd_Animation__ESD;

Esd_AnimationInfo * Ft_Esd_Animation__Get_AnimationInfo__ESD(void *context) { return ((Ft_Esd_Animation__ESD *)context)->AnimationInfo; }
void Ft_Esd_Animation__Set_AnimationInfo__ESD(void *context, Esd_AnimationInfo * value) { ((Ft_Esd_Animation__ESD *)context)->AnimationInfo = value; }

void *Ft_Esd_Animation__Create__ESD()
{
	Ft_Esd_Animation__ESD *context = (Ft_Esd_Animation__ESD *)esd_malloc(sizeof(Ft_Esd_Animation__ESD));
	if (context)
	{
		Ft_Esd_Animation__Initializer(&context->Instance);
		context->Instance.Owner = context;
		context->AnimationInfo = 0;
		context->Instance.AnimationInfo = Ft_Esd_Animation__Get_AnimationInfo__ESD;
	}
	else
	{
		eve_printf_debug("Out of memory (Ft_Esd_Animation__Create__ESD)");
	}
	return context;
}

void Ft_Esd_Animation__Destroy__ESD(void *context)
{
	esd_free(context);
}

void Ft_Esd_Animation__Set_Color__ESD(void *context, ft_argb32_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Color = value; }
void Ft_Esd_Animation__Set_Align__ESD(void *context, uint8_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Align = value; }
void Ft_Esd_Animation__Set_AutoResize__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.AutoResize = value; }
void Ft_Esd_Animation__Set_AutoPlay__ESD(void *context, bool value) { ((Ft_Esd_Animation__ESD *)context)->Instance.AutoPlay = value; }
void Ft_Esd_Animation__Set_Loop__ESD(void *context, int8_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Loop = value; }
void Ft_Esd_Animation__Set_Frame__ESD(void *context, int32_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Frame = value; }
void Ft_Esd_Animation__Set_LastAddr__ESD(void *context, uint32_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.LastAddr = value; }
void Ft_Esd_Animation__Set_Playing__ESD(void *context, bool value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Playing = value; }
void Ft_Esd_Animation__Set_IsSingle__ESD(void *context, bool value) { ((Ft_Esd_Animation__ESD *)context)->Instance.IsSingle = value; }
void Ft_Esd_Animation__Set_Counter__ESD(void *context, int8_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Counter = value; }
void Ft_Esd_Animation__Set_Channel__ESD(void *context, int8_t value) { ((Ft_Esd_Animation__ESD *)context)->Instance.Channel = value; }
