...
{
	Ft_Esd_Elements_CircleFlat__ESD *context = (Ft_Esd_Elements_CircleFlat__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_CircleFlat__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_CircleFlat__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_CircleRaised__ESD *context = (Ft_Esd_Elements_CircleRaised__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_CircleRaised__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_CircleRaised__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_CircleSunken__ESD *context = (Ft_Esd_Elements_CircleSunken__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_CircleSunken__ESD));
	if (context)
	{
		context->color = 0xff151515UL;
		context->x = 0;
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_CircleSunken__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_Gradient_Panel__ESD *context = (Ft_Esd_Elements_Gradient_Panel__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_Gradient_Panel__ESD));
	if (context)
	{
		context->x = 0;
		context->y = 0;
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_Gradient_Panel__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_Panel__ESD *context = (Ft_Esd_Elements_Panel__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_Panel__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_Panel__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_PanelRaised__ESD *context = (Ft_Esd_Elements_PanelRaised__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_PanelRaised__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_PanelRaised__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_PanelSunken__ESD *context = (Ft_Esd_Elements_PanelSunken__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_PanelSunken__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_PanelSunken__Create__ESD)");
	}
	return context;
}
...
{
	Ft_Esd_Elements_Panel_Color__ESD *context = (Ft_Esd_Elements_Panel_Color__ESD *)esd_malloc(sizeof(Ft_Esd_Elements_Panel_Color__ESD));
	if (context)
	{
	...
	{
		eve_printf_debug("Out of memory (Ft_Esd_Elements_Panel_Color__Create__ESD)");
	}
	return context;
}
