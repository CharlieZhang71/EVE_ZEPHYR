...
#define Ft_Esd_LabelButton_CLASSID 0x2662E9EB
...
typedef struct
{
	...
	ESD_INPUT(PressNHold, DisplayName = "PressNHold", Type = bool, Default = false)
	bool(* PressNHold)(void *context);
	ESD_SIGNAL(Pushed)
	void(* Pushed)(void *context);
	ESD_VARIABLE(State, Type = bool, Default = false, Private)
	bool State;
