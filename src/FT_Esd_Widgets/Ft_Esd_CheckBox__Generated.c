...
static Ft_Esd_Theme * Ft_Esd_CheckBox_ESD_Label_Button_Theme__Property(void *context);
static uint8_t Ft_Esd_CheckBox_ESD_Label_Button_Font__Property(void *context);
static Esd_FontInfo * Ft_Esd_CheckBox_ESD_Label_Button_FontResource__Property(void *context);
static const char * Ft_Esd_CheckBox_ESD_Label_Button_Text__Property(void *context);
static ft_bool_t Ft_Esd_CheckBox_ESD_Label_Button_Primary__Property(void *context) { return 0; }
...
static void Ft_Esd_CheckBox_ESD_Label_Button_Pushed__Signal(void *context);
...
void Ft_Esd_CheckBox__ESD_Label_Button__Initializer(Ft_Esd_CheckBox *context)
{
	...
	object->Theme = Ft_Esd_CheckBox_ESD_Label_Button_Theme__Property;
	object->Font = Ft_Esd_CheckBox_ESD_Label_Button_Font__Property;
	object->FontResource = Ft_Esd_CheckBox_ESD_Label_Button_FontResource__Property;
	object->Text = Ft_Esd_CheckBox_ESD_Label_Button_Text__Property;
	object->Primary = Ft_Esd_CheckBox_ESD_Label_Button_Primary__Property;
	object->Pushed = Ft_Esd_CheckBox_ESD_Label_Button_Pushed__Signal;
...
void Ft_Esd_CheckBox__Initializer(Ft_Esd_CheckBox *context)
{
	...
	Ft_Esd_CheckBox__ESD_Label_Button__Initializer(context);
}
...
static Ft_Esd_Theme *Ft_Esd_CheckBox_Local_Method(Ft_Esd_CheckBox *context, Ft_Esd_Theme *theme);
...
Ft_Esd_Theme * Ft_Esd_CheckBox_ESD_Label_Button_Theme__Property(void *c)
{
	Ft_Esd_CheckBox *context = (Ft_Esd_CheckBox *)c;
	void *owner = context->Owner;
	Ft_Esd_Theme * theme_3 = context->Theme(owner);
	return Ft_Esd_CheckBox_Local_Method(context, theme_3);
}

uint8_t Ft_Esd_CheckBox_ESD_Label_Button_Font__Property(void *c)
{
	Ft_Esd_CheckBox *context = (Ft_Esd_CheckBox *)c;
	void *owner = context->Owner;
...
Esd_FontInfo * Ft_Esd_CheckBox_ESD_Label_Button_FontResource__Property(void *c)
{
	Ft_Esd_CheckBox *context = (Ft_Esd_CheckBox *)c;
	void *owner = context->Owner;
...
const char * Ft_Esd_CheckBox_ESD_Label_Button_Text__Property(void *c)
{
	Ft_Esd_CheckBox *context = (Ft_Esd_CheckBox *)c;
	void *owner = context->Owner;
...
void Ft_Esd_CheckBox_ESD_Label_Button_Pushed__Signal(void *c)
{
	Ft_Esd_CheckBox *context = (Ft_Esd_CheckBox *)c;
	void *owner = context->Owner;
	bool if_25 = context->ClickableText;
	if (if_25)
	{
		// Variable writer 'Set_Variable_2' does not write to any variables
		ft_bool_t value_2 = context->Value;
		int set_variable_2 = !value_2;
		context->Value = set_variable_2;
...
void Ft_Esd_CheckBox__Set_ClickableText__ESD(void *context, bool value) { ((Ft_Esd_CheckBox__ESD *)context)->Instance.ClickableText = value; }
