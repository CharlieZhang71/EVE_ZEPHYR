...
typedef struct
{
	Ft_Esd_ScrollingText Instance;
} Ft_Esd_ScrollingText__ESD;


void *Ft_Esd_ScrollingText__Create__ESD()
{
	Ft_Esd_ScrollingText__ESD *context = (Ft_Esd_ScrollingText__ESD *)esd_malloc(sizeof(Ft_Esd_ScrollingText__ESD));
	if (context)
	{
		Ft_Esd_ScrollingText__Initializer(&context->Instance);
		context->Instance.Owner = context;
	}
	else
	{
		eve_printf_debug("Out of memory (Ft_Esd_ScrollingText__Create__ESD)");
	}
	return context;
}

void Ft_Esd_ScrollingText__Destroy__ESD(void *context)
{
	esd_free(context);
}

void Ft_Esd_ScrollingText__Set_GlobalX__ESD(void *context, int value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.GlobalX = value; }
void Ft_Esd_ScrollingText__Set_Theme__ESD(void *context, Ft_Esd_Theme *value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Theme = value; }
void Ft_Esd_ScrollingText__Set_Variable_2__ESD(void *context, int value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Variable_2 = value; }
void Ft_Esd_ScrollingText__Set_Font_Resource__ESD(void *context, Esd_FontInfo *value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Font_Resource = value; }
void Ft_Esd_ScrollingText__Set_Font__ESD(void *context, int value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Font = value; }
void Ft_Esd_ScrollingText__Set_Text__ESD(void *context, const char *value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Text = value; }
void Ft_Esd_ScrollingText__Set_Position__ESD(void *context, int value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Position = value; }
void Ft_Esd_ScrollingText__Set_Speed__ESD(void *context, int value) { ((Ft_Esd_ScrollingText__ESD *)context)->Instance.Speed = value; }
