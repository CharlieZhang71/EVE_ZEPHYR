...
#define Ft_Esd_Image_CLASSID 0x19B9106F
ESD_SYMBOL(Ft_Esd_Image_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_Image, Include = "Ft_Esd_Image.h", Callback, DisplayName = "ESD Image", Category = EsdWidgets, Icon = ":/icons/image-medium.png", X = 70, Y = 92, Width = 100, Height = 100)
typedef struct
{
	union
	{
