...
#define Ft_Esd_ArcLine_CLASSID 0xE9EF680C
ESD_SYMBOL(Ft_Esd_ArcLine_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_ArcLine, Include = "Ft_Esd_ArcLine.h", Callback, DisplayName = "ESD Arc Line", Category = EsdBasicWidgets, Icon = ":/icons/layer-shape-curve.png", X = 18, Y = 22, Width = 302, Height = 285, BackToFront)
typedef struct
{
	union
	{
