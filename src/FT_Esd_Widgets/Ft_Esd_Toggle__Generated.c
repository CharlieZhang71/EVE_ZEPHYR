...
static ft_argb32_t Ft_Esd_Toggle_Get_Default_Color__return(Ft_Esd_Toggle *context);
...
void Ft_Esd_Toggle_Render(Ft_Esd_Toggle *context)
{
	...
	ft_argb32_t c_3 = Ft_Esd_Theme_GetTextColor(theme_2);
...
ft_argb32_t Ft_Esd_Toggle_Get_Default_Color__return(Ft_Esd_Toggle *context)
{
	void *owner = context->Owner;
...
void Ft_Esd_Toggle_Touch_Tag_Tap__Signal(void *c)
{
	...
	void *owner = context->Owner;
	ft_bool_t value_2 = context->State;
	int set_variable_1 = !value_2;
...
{
	Ft_Esd_Toggle__ESD *context = (Ft_Esd_Toggle__ESD *)esd_malloc(sizeof(Ft_Esd_Toggle__ESD));
	if (context)
	{
...
void Ft_Esd_Toggle__Set_Style__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_Toggle__ESD *)context)->Instance.Style = value; }
