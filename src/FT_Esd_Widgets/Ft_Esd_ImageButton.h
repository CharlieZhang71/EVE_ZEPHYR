...
#define Ft_Esd_ImageButton_CLASSID 0xA8928BAE
ESD_SYMBOL(Ft_Esd_ImageButton_CLASSID, Type = esd_classid_t)

/* Push button with image support */
ESD_WIDGET(Ft_Esd_ImageButton, Include = "Ft_Esd_ImageButton.h", Callback, DisplayName = "ESD Image Button", Category = EsdWidgets, DefaultSignal = Pushed, Icon = ":/icons/ui-button-image.png", X = 0, Y = 0, Width = 100, Height = 100)
typedef struct
{
	union
	{
	...
	/* Change Background Image every time clicked */
	ESD_VARIABLE(SwitchOnClicked, DisplayName = "SwitchOnClicked", Type = ft_bool_t, Public)
	ft_bool_t SwitchOnClicked;
	ESD_VARIABLE(Color, Type = ft_argb32_t, Default = #ffffff, Public)
	ft_argb32_t Color;
	ESD_VARIABLE(ShowNormal, Type = ft_bool_t, Default = true, Private)
	ft_bool_t ShowNormal;
