...
ESD_FUNCTION(Ft_Esd_Char_RightTriangle, Type = const char *, Category = _GroupHidden, Inline)
inline static const char *Ft_Esd_Char_RightTriangle() { return "\x10"; }

ESD_FUNCTION(Ft_Esd_Char_LeftTriangle, Type = const char *, Category = _GroupHidden, Inline)
inline static const char *Ft_Esd_Char_LeftTriangle() { return "\x11"; }

ESD_FUNCTION(Ft_Esd_Char_UpTriangle, Type = const char *, Category = _GroupHidden, Inline)
inline static const char *Ft_Esd_Char_UpTriangle() { return "\x1E"; }

ESD_FUNCTION(Ft_Esd_Char_DownTriangle, Type = const char *, Category = _GroupHidden, Inline)
inline static const char *Ft_Esd_Char_DownTriangle() { return "\x1F"; }
