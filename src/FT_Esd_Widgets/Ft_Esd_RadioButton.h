...
#define Ft_Esd_RadioButton_CLASSID 0xA9B15167
ESD_SYMBOL(Ft_Esd_RadioButton_CLASSID, Type = esd_classid_t)

/* Classic radio button widget with label */
ESD_WIDGET(Ft_Esd_RadioButton, Include = "Ft_Esd_RadioButton.h", Callback, DisplayName = "ESD Radio Button", Category = EsdWidgets, Icon = ":/icons/ui-radio-button.png", X = 0, Y = 0, Width = 20, Height = 20)
typedef struct
{
	union
	{
