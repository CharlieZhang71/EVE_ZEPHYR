...
#define Ft_Esd_CircleLine_CLASSID 0x871FD465
ESD_SYMBOL(Ft_Esd_CircleLine_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_CircleLine, Include = "Ft_Esd_CircleLine.h", Callback, DisplayName = "ESD Circle Line", Category = EsdBasicWidgets, Icon = ":/icons/layer-shape-ellipse.png", X = 14, Y = 12, Width = 252, Height = 261, BackToFront)
typedef struct
{
	union
	{
