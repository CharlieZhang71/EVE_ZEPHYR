...
int Ft_Esd_ColorPicker_Lightness__Default(void *context) { return 255L; }
...
void Ft_Esd_ColorPicker__Initializer(Ft_Esd_ColorPicker *context)
{
	...
	context->Radius = 125L;
	context->Lightness = Ft_Esd_ColorPicker_Lightness__Default;
...
static ft_argb32_t Ft_Esd_ColorPicker_Local_Method(Ft_Esd_ColorPicker *context, int lightness, esd_argb32_t color);
...
void Ft_Esd_ColorPicker_Update(Ft_Esd_ColorPicker *context)
{
	...
	if (if_1)
	{
		...
		int v = context->Lightness(owner);
		set_variable = hsvToRgb(h, s_2, v);
	}
	else
	{
		int lightness = context->Lightness(owner);
		ft_argb32_t color = context->Color;
		set_variable = Ft_Esd_ColorPicker_Local_Method(context, lightness, color);
	}
...
int Ft_Esd_ColorPicker__Get_Lightness__ESD(void *context) { return ((Ft_Esd_ColorPicker__ESD *)context)->Lightness; }
void Ft_Esd_ColorPicker__Set_Lightness__ESD(void *context, int value) { ((Ft_Esd_ColorPicker__ESD *)context)->Lightness = value; }

void *Ft_Esd_ColorPicker__Create__ESD()
{
	Ft_Esd_ColorPicker__ESD *context = (Ft_Esd_ColorPicker__ESD *)esd_malloc(sizeof(Ft_Esd_ColorPicker__ESD));
	if (context)
	{
		Ft_Esd_ColorPicker__Initializer(&context->Instance);
		context->Instance.Owner = context;
		context->Lightness = 255L;
		context->Instance.Lightness = Ft_Esd_ColorPicker__Get_Lightness__ESD;
	}
	else
	{
