...
uint8_t Ft_Esd_Numberpad__Get_Font__ESD(void *context) { return ((Ft_Esd_Numberpad__ESD *)context)->Font; }
void Ft_Esd_Numberpad__Set_Font__ESD(void *context, uint8_t value) { ((Ft_Esd_Numberpad__ESD *)context)->Font = value; }
Esd_FontInfo * Ft_Esd_Numberpad__Get_FontResource__ESD(void *context) { return ((Ft_Esd_Numberpad__ESD *)context)->FontResource; }
void Ft_Esd_Numberpad__Set_FontResource__ESD(void *context, Esd_FontInfo * value) { ((Ft_Esd_Numberpad__ESD *)context)->FontResource = value; }
Ft_Esd_Theme * Ft_Esd_Numberpad__Get_Theme__ESD(void *context) { return ((Ft_Esd_Numberpad__ESD *)context)->Theme; }
void Ft_Esd_Numberpad__Set_Theme__ESD(void *context, Ft_Esd_Theme * value) { ((Ft_Esd_Numberpad__ESD *)context)->Theme = value; }
...
void *Ft_Esd_Numberpad__Create__ESD()
{
	...
	if (context)
	{
		...
		context->Font = 27;
		context->Instance.Font = Ft_Esd_Numberpad__Get_Font__ESD;
		context->FontResource = 0;
		context->Instance.FontResource = Ft_Esd_Numberpad__Get_FontResource__ESD;
		context->Theme = Ft_Esd_Theme_GetCurrent();
		context->Instance.Theme = Ft_Esd_Numberpad__Get_Theme__ESD;
	}
	else
	{
...
void Ft_Esd_Numberpad__Set_baseLine__ESD(void *context, uint16_t value) { ((Ft_Esd_Numberpad__ESD *)context)->Instance.baseLine = value; }
void Ft_Esd_Numberpad__Set_capsHeight__ESD(void *context, uint16_t value) { ((Ft_Esd_Numberpad__ESD *)context)->Instance.capsHeight = value; }
void Ft_Esd_Numberpad__Set_xOffset__ESD(void *context, uint16_t value) { ((Ft_Esd_Numberpad__ESD *)context)->Instance.xOffset = value; }
void Ft_Esd_Numberpad__Set_myFont__ESD(void *context, uint16_t value) { ((Ft_Esd_Numberpad__ESD *)context)->Instance.myFont = value; }
