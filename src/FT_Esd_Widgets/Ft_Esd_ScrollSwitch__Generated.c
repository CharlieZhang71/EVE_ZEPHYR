...
uint8_t Ft_Esd_ScrollSwitch__Get_Align__ESD(void *context) { return ((Ft_Esd_ScrollSwitch__ESD *)context)->Align; }
void Ft_Esd_ScrollSwitch__Set_Align__ESD(void *context, uint8_t value) { ((Ft_Esd_ScrollSwitch__ESD *)context)->Align = value; }
...
{
	Ft_Esd_ScrollSwitch__ESD *context = (Ft_Esd_ScrollSwitch__ESD *)esd_malloc(sizeof(Ft_Esd_ScrollSwitch__ESD));
	if (context)
	{
		...
		context->Align = ESD_ALIGN_FILLLEFT;
		context->Instance.Align = Ft_Esd_ScrollSwitch__Get_Align__ESD;
