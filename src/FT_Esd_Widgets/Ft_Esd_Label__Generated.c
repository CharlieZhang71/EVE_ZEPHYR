...
{
	Ft_Esd_Label__ESD *context = (Ft_Esd_Label__ESD *)esd_malloc(sizeof(Ft_Esd_Label__ESD));
	if (context)
	{
...
void Ft_Esd_Label__Set_BackGroundAlpha__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_Label__ESD *)context)->Instance.BackGroundAlpha = value; }
