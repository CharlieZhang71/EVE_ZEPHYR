...
#define Ft_Esd_PushButton_CLASSID 0x2FC7AD30
...
typedef struct
{
	...
	ft_uint8_t Style;
	/* If this parameter enabled, hold the button and it will keep on emitting signal on timeout */
	ESD_VARIABLE(LongPush, Type = ft_bool_t, Public)
	ft_bool_t LongPush;
	/* Define interval of emiting a new signal if hold the button. Unit is millisecond */
	ESD_VARIABLE(Interval, Type = int, Default = 1000, Public)
	int Interval;
