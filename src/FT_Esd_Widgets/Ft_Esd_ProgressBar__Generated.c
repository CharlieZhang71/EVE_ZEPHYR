...
{
	Ft_Esd_ProgressBar__ESD *context = (Ft_Esd_ProgressBar__ESD *)esd_malloc(sizeof(Ft_Esd_ProgressBar__ESD));
	if (context)
	{
...
void Ft_Esd_ProgressBar__Set_Style__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_ProgressBar__ESD *)context)->Instance.Style = value; }
