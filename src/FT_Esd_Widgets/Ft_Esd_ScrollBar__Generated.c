...
static ft_argb32_t Ft_Esd_ScrollBar_Ft_Esd_Theme_GetBackColor__return(Ft_Esd_ScrollBar *context);
...
ft_argb32_t Ft_Esd_ScrollBar_Ft_Esd_Theme_GetBackColor__return(Ft_Esd_ScrollBar *context)
{
	void *owner = context->Owner;
...
{
	void *owner = context->Owner;
	ft_int16_t value_1 = context->Value;
	ft_int16_t min = context->Min(owner);
	ft_int16_t max = context->Max(owner);
	return Ft_Esd_Int16_ClampedValue(value_1, min, max);
}
...
{
	Ft_Esd_ScrollBar__ESD *context = (Ft_Esd_ScrollBar__ESD *)esd_malloc(sizeof(Ft_Esd_ScrollBar__ESD));
	if (context)
	{
...
void Ft_Esd_ScrollBar__Set_Style__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_ScrollBar__ESD *)context)->Instance.Style = value; }
