...
#define Ft_Esd_CircularGradient_CLASSID 0x29DDB537
ESD_SYMBOL(Ft_Esd_CircularGradient_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_CircularGradient, Include = "Ft_Esd_CircularGradient.h", Callback, DisplayName = "ESD Circular Gradient", Category = EsdBasicWidgets, Icon = ":/icons/gradient.png", X = 657, Y = 462, Width = 320, Height = 315)
typedef struct
{
	union
	{
	...
	ft_uint8_t Check_Gradient_Type_Changed__0;
