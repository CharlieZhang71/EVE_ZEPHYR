...
{
	Ft_Esd_PushButton__ESD *context = (Ft_Esd_PushButton__ESD *)esd_malloc(sizeof(Ft_Esd_PushButton__ESD));
	if (context)
	{
...
void Ft_Esd_PushButton__Set_Style__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_PushButton__ESD *)context)->Instance.Style = value; }
void Ft_Esd_PushButton__Set_LongPush__ESD(void *context, ft_bool_t value) { ((Ft_Esd_PushButton__ESD *)context)->Instance.LongPush = value; }
void Ft_Esd_PushButton__Set_Interval__ESD(void *context, int value) { ((Ft_Esd_PushButton__ESD *)context)->Instance.Interval = value; }
