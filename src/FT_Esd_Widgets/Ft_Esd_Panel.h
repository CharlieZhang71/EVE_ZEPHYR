...
#define Ft_Esd_Panel_CLASSID 0x0CBA763C
ESD_SYMBOL(Ft_Esd_Panel_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_Panel, Include = "Ft_Esd_Panel.h", Callback, DisplayName = "ESD Panel", Category = EsdBasicWidgets, Icon = ":/icons/ui-panel.png", X = 82, Y = 44, Width = 276, Height = 198)
typedef struct
{
	union
	{
