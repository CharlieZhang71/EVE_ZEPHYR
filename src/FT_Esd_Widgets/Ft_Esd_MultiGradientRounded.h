...
#define Ft_Esd_MultiGradientRounded_CLASSID 0xD30CD4BE
ESD_SYMBOL(Ft_Esd_MultiGradientRounded_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_MultiGradientRounded, Include = "Ft_Esd_MultiGradientRounded.h", Callback, DisplayName = "ESD Multi Gradient (Rounded)", Category = EsdBasicWidgets, Icon = ":/icons/gradient.png", X = 0, Y = 0, Width = 300, Height = 225)
typedef struct
{
	union
	{
	...
	ESD_VARIABLE(Alpha, Type = ft_uint8_t, Min = 0, Max = 255, SingleStep = 1, Default = 255, Public)
	ft_uint8_t Alpha;
