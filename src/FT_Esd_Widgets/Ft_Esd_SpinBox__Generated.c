...
{
	Ft_Esd_SpinBox__ESD *context = (Ft_Esd_SpinBox__ESD *)esd_malloc(sizeof(Ft_Esd_SpinBox__ESD));
	if (context)
	{
...
void Ft_Esd_SpinBox__Set_Style__ESD(void *context, ft_uint8_t value) { ((Ft_Esd_SpinBox__ESD *)context)->Instance.Style = value; }
void Ft_Esd_SpinBox__Set_SideButtons__ESD(void *context, bool value) { ((Ft_Esd_SpinBox__ESD *)context)->Instance.SideButtons = value; }
