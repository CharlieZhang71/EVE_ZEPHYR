...
#define Ft_Esd_Sketch_CLASSID 0x3FC8DE30
ESD_SYMBOL(Ft_Esd_Sketch_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_Sketch, Include = "Ft_Esd_Sketch.h", Callback, DisplayName = "ESD Sketch", Category = EsdWidgets, Icon = ":/icons/palette--pencil.png", X = 50, Y = 50, Width = 200, Height = 150)
typedef struct
{
	union
	{
