...
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(c, Type = esd_rgb32_t, DisplayName = "Color")
/**
...
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(c, Type = esd_argb32_t, DisplayName = "Color")
/**
...
/* Set current tag. Must be returned to EVE_TAG_NONE (255) after usage,
to ensure next widgets don't draw with invalid tag. Maximum value is 255 on FT80X, FT81X, BT81X, and BT88X */
ESD_FUNCTION(EVE_CoDl_tag, Type = void, Category = EveRenderFunctions, Inline)
ESD_PARAMETER(phost, Type = EVE_HalContext *, Default = Esd_GetHost, Hidden, Internal, Static) // PHOST
ESD_PARAMETER(s, Type = eve_tag_t, DisplayName = "Tag", Default = 255, Min = 1, Max = 16777215)
/**
 ...
 * @param s
 */
inline static void EVE_CoDl_tag(EVE_HalContext *phost, eve_tag_t s)
{
 ...
 * @param s
 */
static inline void EVE_CoDl_clearTag(EVE_HalContext *phost, eve_tag_t s)
{
