...
ESD_TARGET_PLATFORM(EVE_PLATFORM_ZEPHYR, DisplayName = "nRF54H20", SupportedArchitectures = "\bZephyr\b")
...
- ZEPHYR_PLATFORM (set EVE_PLATFORM_ZEPHYR)										 
...
*/
    ...
    || defined(EVE_GRAPHICS_BT820)                                   \
    || defined(EVE_GRAPHICS_GD3X_DAZZLER)                            \
    || defined(EVE_GRAPHICS_IDM2040) || defined(EVE_GRAPHICS_VM820C) \
    || defined(EVE_GRAPHICS_IDM2040_43A)                             \
    || defined(EVE_GRAPHICS_IDM2040_21R) || defined(EVE_GRAPHICS_IDP_1000_04A) \
...
#define EVE_GRAPHICS_AVAILABLE
	...
	|| defined(EVE_DISPLAY_FHD) || defined(EVE_DISPLAY_HDTV)   \
...
#elif defined(EVE_GRAPHICS_VM816C) && defined(EVE_PLATFORM_ZEPHYR)
...
#elif defined(EVE_GRAPHICS_VM820C)
...
#elif defined(EVE_GRAPHICS_ME817EV) && defined(EVE_PLATFORM_FT4222)
...
#elif defined(EVE_GRAPHICS_IDP_1000_04A)
...
#elif defined(EVE_GRAPHICS_IDP_4000_04A)
...
#ifndef EVE_TOUCH_AVAILABLE
#define EVE_TOUCH_AVAILABLE
#ifdef DISPLAY_RESOLUTION_WQVGA_SQ
#define EVE_TOUCH_GOODIX
#endif
#endif

#elif defined(EVE_GRAPHICS_IDP_3500_04A)
#define FT811_ENABLE
#define ENABLE_SPI_QUAD

#ifndef EVE_DISPLAY_AVAILABLE
#define EVE_DISPLAY_AVAILABLE
#define EVE_DISPLAY_HVGA
...
#elif defined(EVE_GRAPHICS_IDP_5000_04A)
#define FT813_ENABLE
#define ENABLE_SPI_QUAD
...
#elif defined(EVE_GRAPHICS_IDM2040_21R)
...
#define EVE_DISPLAY_AVAILABLE
#define DISPLAY_RESOLUTION_WQVGA_SQ
#define ENABLE_IDM2040_21R_RP2040
#endif
...
#elif defined(EVE_GRAPHICS_BT820)
...
#define DISPLAY_RESOLUTION_WQVGA
#elif defined(EVE_DISPLAY_WQVGA_SQ)
#define DISPLAY_RESOLUTION_WQVGA_SQ
...
#elif defined(EVE_DISPLAY_WUXGA)
#define DISPLAY_RESOLUTION_WUXGA
#elif defined(EVE_DISPLAY_HVGA)
#define DISPLAY_RESOLUTION_HVGA_PORTRAIT
...
#elif defined(EVE_FLASH_W25N01GV)
#define EVE_FLASH_W25N
...
#ifdef _WIN32
#define EVE_FLASH_FIRMWARE L"BT820/unified.blob"
#else
#define EVE_FLASH_FIRMWARE "BT820/unified.blob"
#endif
...
#if defined(ESD_PREPROCESSOR_TRIM) && defined(EVE_HAL_EXPORT)
#undef EVE_HAL_EXPORT
#define EVE_HAL_EXPORT __undetermined__
#endif
...
#define MPSSE_PLATFORM
#define BT8XXEMU_PLATFORM
#ifdef ESD_PREPROCESSOR_TRIM
#define EVE_HOST __undetermined__
#else
...
#define RESISTANCE_THRESHOLD (1800)
#ifdef ESD_PREPROCESSOR_TRIM
#define EVE_CHIPID __undetermined__
#define EVE_GEN __undetermined__
#else
...
#undef printf
#endif
#define printf __undetermined__
#ifdef iprintf
#undef iprintf
#endif
#define iprintf __undetermined__
#ifdef malloc
#undef malloc
#endif
#define malloc __undetermined__
#ifdef calloc
#undef calloc
#endif
#define calloc __undetermined__
#ifdef free
#undef free
#endif
#define free __undetermined__
#endif
...
#if defined(FT9XX_PLATFORM) || (defined(RP2040_PLATFORM) && !defined(ENABLE_IDM2040_21R_RP2040))
