...
// FIXME: Use ESD_ prefixes for enums
ESD_ENUM(Esd_ImageAnimation, Type = int, Include = "Esd_Core.h")
#define IMAGE_RIGHT_TO_LEFT (0)
#define IMAGE_LEFT_TO_RIGHT (1)
#define IMAGE_BOTTOM_TO_TOP (2)
#define IMAGE_TOP_TO_BOTTOM (3)
#define IMAGE_FADE_IN (4)
#define IMAGE_FADE_OUT (5)
ESD_END()

// FIXME: Use ESD_ prefixes for enums
ESD_ENUM(Esd_ScrollText, Type = int, Include = "Esd_Core.h")
#define NONE (0)
